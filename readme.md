...
```bash
git clone https://github.com/MBA-Mackenzie/aumtomacao-ci-cd.git
cd aumtomacao-ci-cd

echo "# aumtomacao-ci-cd" >> README.md
git init
git add README.md
git commit -m "first commit"
git branch -M main
git remote add origin https://github.com/MBA-Mackenzie/aumtomacao-ci-cd.git
